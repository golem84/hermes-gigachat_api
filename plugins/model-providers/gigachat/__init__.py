...
def _get_gigachat_token() -> str | None:
    ...
    # According to the docs, we might need to use basic auth with client_id:client_secret
    # or the token might be directly provided as GIGACHAT_API_TOKEN
    api_token = os.getenv("GIGACHAT_API_TOKEN")
    
    if api_token:
        # Token is already provided
        return api_token
    ...
    headers = {
        ...
        "RqUID": os.urandom(16).hex(),  # Generate random UUID
    }
